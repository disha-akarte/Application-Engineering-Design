...
import Business.RoleNew.NurseRole;
import Business.RoleNew.ReceptionstRole;
...
public class ManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        if (!pm.getPassword_pattern().matcher(String.valueOf(passwordJPasswordField.getPassword())).matches()) {
        ...
        Boolean unique = organization.getUserAccountDirectory().checkIfUsernameIsUnique(userName);
        if (unique == false) {
    ...
    private void employeeJComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_employeeJComboBoxActionPerformed
        ...
        if (org instanceof NurseOrganization) {
            role1 = new NurseRole();
            roleJComboBox.addItem(role1);

        } else if (org instanceof ReceptionistOrganization) {
            role1 = new ReceptionstRole();
            roleJComboBox.addItem(role1);
        }
